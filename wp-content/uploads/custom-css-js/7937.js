...
jQuery(document).ready(function( $ ){
  ...
  const dataMarkers = [
    ...
    { nameMarker: "Ingresar al Stand", idMarker: "512AEE6D76", nameScene: "Stand Acepalma", idScene: "0684F3D38B", points:0 },
  ...
  const dataScenes = [
    ...
    { nameScene: "Stand Acepalma Interior", idScene: "E160F86428" },
  ...
  //jQuery('.stand-eimpsa').on('click', () => { onSetScene( "D567489691", 'Muestra comercial', "Stand EIMPSA", 100 ) });  
