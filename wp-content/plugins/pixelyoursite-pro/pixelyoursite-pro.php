...
update_option($license_key, '1415b451be1a13c283ba771ea52d38bb');
update_option($license_expires, '1893456000');
update_option($license_action, 'activate');

define( 'PYS_VERSION', '8.4.2' );
